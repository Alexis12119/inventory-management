...
const AddEquipmentModal = ({ isOpen, onClose, onAdd }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      <div className="absolute inset-0 bg-black opacity-50" onClick={onClose}></div> {/* Overlay for dimming */}
      <div className="bg-white rounded shadow-lg p-8  relative"> {/* Make sure to add relative positioning */}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between">
            ...
            <button type="button" onClick={onClose} className="bg-gray-300 text-black py-3 px-6 rounded">
              Cancel
            </button>
          </div>
        </form>
